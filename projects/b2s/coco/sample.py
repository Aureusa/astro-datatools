...
from astro_datatools.core.datasets.coco.utils import save_coco_image
...
class LoTSS_B2S_Sample(CocoSampleBase):
    def __init__(
        ...
        # Proposed boxes and proposal-conditioned features
    ...
    def _save_proposals(self):
        """Save proposals and proposal-conditioned features."""
    ...
    def _generate_image_filename(self) -> str:
        ...
        filename = f"LoTSS_B2S_{image_id}{rotation_suffix}{rotation_angle_suffix}{coordinates_suffix}.png"
        return filename
